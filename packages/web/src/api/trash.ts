...
// Recoverable deletion. Deleting a recipe is a call against the recipe;
// restoring and destroying it are calls against Trash, because while it is in
// there the recipe's own URL is a 404.
